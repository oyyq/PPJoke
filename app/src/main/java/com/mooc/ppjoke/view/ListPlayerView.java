...
public class ListPlayerView extends FrameLayout implements IPlayTarget, PlayerControlView.VisibilityListener, Player.EventListener {
    ...
    public ListPlayerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_player_view, this, true);      //R.layout.layout_player_view的根节点是merge
    ...
    /**
     * 将google...exoplayer2.ui.PlayerView & google...exoplayer2.ui.PlayerControlView 附加到ListPlayerView
     */
    @Override
    public void onActive() {
        ...
        //为什么呢？因为在列表页点击视频Item跳转到视频详情页的时候，详情页会"复用"列表页的播放器"Exoplayer", 然后和"新创建"的展示视频画面的"View ExoplayerView"相关联, 达到视频无缝续播的效果
    ...
    /**
     * onAttachedToWindow & onDetachedFromWindow的调用时序:https://blog.csdn.net/hty1053240123/article/details/76507265
     */
    @Override
    ...
    public void inActive() {
        ...
        PageListPlay pageListPlay = PageListPlayManager.get(mCategory);
        if (pageListPlay.exoPlayer == null || pageListPlay.controlView == null || pageListPlay.playerView == null) return;
    ...
    /**
     * PlayerControlView的VisibilityListener回调
     * @param visibility
     */
    @Override
    ...
    /**
     * exoPlayer.addListener(Player.EventListener) 的回调
     * @param playWhenReady
     * @param playbackState
     */
    @Override
