...
public class StatusBar {
    ...
    public static void fitSystemBar(Activity activity) {
        ...
        //看FLAG_TRANSLUCENT_STATUS 及 FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS的注释
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        //给statusBar背景改成无色透明后用getStatusBarColor填充颜色
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        //window.addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);          //状态栏隐藏, 有动画
