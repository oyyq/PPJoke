        ...
        if ((dirtyFlags & 0x7bL) != 0) {
            ...
            if ((dirtyFlags & 0x4bL) != 0) {
                ...
                if((dirtyFlags & 0x4bL) != 0) {
                    ...
                    feedUgcHasLikedLikeAndroidDrawableIconCellLikedLikeAndroidDrawableIconCellLike = ((feedUgcHasLiked) ? (androidx.appcompat.content.res.AppCompatResources.getDrawable(like.getContext(), R.drawable.icon_cell_liked)) : (androidx.appcompat.content.res.AppCompatResources.getDrawable(like.getContext(), R.drawable.icon_cell_like)));
            ...
            if ((dirtyFlags & 0x53L) != 0) {
                ...
                if((dirtyFlags & 0x53L) != 0) {
                    ...
                    feedUgcHasdissDissAndroidDrawableIconCellDissedDissAndroidDrawableIconCellDiss = ((feedUgcHasdiss) ? (androidx.appcompat.content.res.AppCompatResources.getDrawable(diss.getContext(), R.drawable.icon_cell_dissed)) : (androidx.appcompat.content.res.AppCompatResources.getDrawable(diss.getContext(), R.drawable.icon_cell_diss)));
            }
        }
        // batch finished
