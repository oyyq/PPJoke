...
public class VideoViewHandler extends ViewHandler {
    ...
    public VideoViewHandler(FragmentActivity activity) {
        ...
        //另一种给CoordinatorLayout的子View添加CoordinatorLayout#Behavior的方法, mVideoBinding.authorInfo是ViewDataBinding的子类, getRoot拿到Inflater inflate出来的View
